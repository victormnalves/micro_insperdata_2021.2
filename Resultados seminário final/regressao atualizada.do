...
margins, dydx(catES)
marginsplot, nolabels allxlabels xtitle("Efeito marginal sobre" "o status de emprego", size(small)) ytitle("Efeitos em Y (Não aceitação" "da violência contra mulher)", size(small)) title("Efeito marginal com 95%" "de confiança") xlabel(1 "Full time" 2 "Part time" 3 "Self Employed" 4 "Retired" 5 "Housewife" 6 `""Other" " ""', labsize(vsmall))
